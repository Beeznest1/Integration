...
def PostProject():
    ...
    driver.find_element(By.XPATH, locators.position).send_keys("Software QA")  # Position Type
    sleep(2)
    driver.find_element(By.XPATH, locators.ProjectName).send_keys("Innovative Research and Consulting")  # Project/Company Name
